-- Belezza API - Migration V26
-- Fix professional-service relationships for all service types
-- Ensures all professionals are linked to relevant services based on their category
